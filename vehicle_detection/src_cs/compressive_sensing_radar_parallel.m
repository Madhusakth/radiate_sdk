...
saveDir = char(strcat('/home/ms75986/Desktop/Qualcomm/Radar-Samp/Adaptive-Radar-Acquisition/data/oxford-v1/scene', string(scene),'/final-image-info-5/'));
x_point_rearDir = char(strcat('/home/ms75986/Desktop/Qualcomm/Radar-Samp/Adaptive-Radar-Acquisition/data/oxford-v1/scene', string(scene),'/radar-x-points-rear-left18Close/'));
x_point_centreDir = char(strcat('/home/ms75986/Desktop/Qualcomm/Radar-Samp/Adaptive-Radar-Acquisition/data/oxford-v1/scene', string(scene),'/radar-x-points-centre-left18Close/'));
...
for k = 1: parallel
    ...
    if level2 == 0
        %level2 = 1;
	disp('Generating random level 2 samples')
    ...
    if level3 == 0
        %level3 = 1;
	disp('Generating random level 3 samples')
        samp_idx = find(sampler==0);
        rand_idx = randi(length(samp_idx));
